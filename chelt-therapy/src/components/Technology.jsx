...
function WaveformSVG({ mode }) {
    const patterns = {
        ...
        'Burst I':           'M0,80 L10,80 10,25 16,25 16,80 22,80 22,25 28,25 28,80 34,80 34,25 40,25 40,80 90,80 90,25 96,25 96,80 102,80 102,25 108,25 108,80 114,80 114,25 120,25 120,80 170,80 170,25 176,25 176,80 182,80 182,25 188,25 188,80 194,80 194,25 200,25 200,80 250,80 250,25 256,25 256,80 262,80 262,25 268,25 268,80 274,80 274,25 280,25 280,80 330,80 330,25 336,25 336,80 342,80 342,25 348,25 348,80 354,80 354,25 360,25 360,80 400,80',
        'Burst II':          'M0,80 L8,80 8,25 12,25 12,80 16,80 16,25 20,25 20,80 24,80 24,25 28,25 28,80 32,80 32,25 36,25 36,80 40,80 40,25 44,25 44,80 100,80 100,25 104,25 104,80 108,80 108,25 112,25 112,80 116,80 116,25 120,25 120,80 124,80 124,25 128,25 128,80 132,80 132,25 136,25 136,80 200,80 200,25 204,25 204,80 208,80 208,25 212,25 212,80 216,80 216,25 220,25 220,80 224,80 224,25 228,25 228,80 300,80 300,25 304,25 304,80 308,80 308,25 312,25 312,80 316,80 316,25 320,25 320,80 324,80 324,25 328,25 328,80 400,80',
        'Pulso Único':       'M0,80 L180,80 180,12 220,12 220,80 400,80',
        'Antiinflamatorio':  'M0,60 Q25,20 50,60 Q75,100 100,60 Q125,20 150,60 Q175,100 200,60 Q225,20 250,60 Q275,100 300,60 Q325,20 350,60 Q375,100 400,60',
        'Bioestimulación':   'M0,50 Q10,30 20,50 Q30,70 40,50 Q50,30 60,50 Q70,70 80,50 Q90,30 100,50 Q110,70 120,50 Q130,30 140,50 Q150,70 160,50 Q170,30 180,50 Q190,70 200,50 Q210,30 220,50 Q230,70 240,50 Q250,30 260,50 Q270,70 280,50 Q290,30 300,50 Q310,70 320,50 Q330,30 340,50 Q350,70 360,50 Q370,30 380,50 Q390,70 400,50',
        'Analgésico':        'M0,50 Q50,10 100,50 Q150,90 200,50 Q250,10 300,50 Q350,90 400,50',
        'Regenerativo':      'M0,80 L20,80 20,35 Q30,15 40,35 L40,80 80,80 80,35 Q90,15 100,35 L100,80 140,80 140,35 Q150,15 160,35 L160,80 200,80 200,35 Q210,15 220,35 L220,80 260,80 260,35 Q270,15 280,35 L280,80 320,80 320,35 Q330,15 340,35 L340,80 380,80 380,35 Q390,15 400,35',
        'Drenaje':           'M0,50 C20,20 40,80 60,50 C80,20 100,80 120,50 C140,20 160,80 180,50 C200,20 220,80 240,50 C260,20 280,80 300,50 C320,20 340,80 360,50 C380,20 400,80 400,50',
    };
    return (
                ...
                <div className="tech__block reveal reveal-delay-1">
                    ...
                    <div className="tech__wave-selector">
                        {technologyContent.wavelengths.map((wl, i) => (
                            ...
                            >
                                ...
                                <span className="tech__wave-btn-nm">{wl.nm}{wl.nm !== 'MLS' && <span className="tech__wave-btn-unit">nm</span>}</span>
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="tech__wave-detail" key={activeWave}>
                        <div className="tech__wave-detail-left">
                            <div className="tech__wave-detail-nm" style={{ color: WAVE_COLORS[activeWave] }}>{w.nm}{w.nm !== 'MLS' ? ' nm' : ''}</div>
